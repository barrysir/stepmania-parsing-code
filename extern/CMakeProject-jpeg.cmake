if(WITH_SYSTEM_JPEG)
  ...
  set(JPEG_BUILD_DIR "${SM_BUILD_EXTERN_DIR}/libjpeg")

  if(NOT HAVE_PROTOTYPES)
    list(APPEND JPEG_SRC "${JPEG_DIR}/ansi2knr.c")
  endif()
  
  configure_file("${SM_EXTERN_DIR}/config.jpeg.in.h" "${JPEG_BUILD_DIR}/jconfig.h")
  ...
  target_include_directories("jpeg" PUBLIC "${JPEG_BUILD_DIR}")   # for jconfig.h
